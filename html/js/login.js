...
lg.initTarget = function () {
    ...
    $("#gLogin").on("click", function (e) {
        ...
        let params = $.param({
            client_id: "102363313215-408im4hc7mtsgrda4ratkro2thn58bcd.apps.googleusercontent.com",
            response_type: "code id_token",
            scope: "openid email profile",
            redirect_uri: homeAppUrl + "__/html/homeapp_google_auth.html",
            display: "popup",
            nonce: "personium",
            state: homeUrl
        });
    ...
    $("#gLogin > img").attr("src", homeAppUrl + "__/html/img/parts_ico_google.png");
    $("#imError").attr("src", homeAppUrl + "__/html/img/ico_error.png");

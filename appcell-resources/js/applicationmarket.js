...
am.createApplicationList = function() {
    var html = '<div class="panel-body" id="app-panel"><section class="dashboard-block" id="installed-app"><h2>' + i18next.t("Installed") + '</h2><div id="insAppList1"></div></section><section class="dashboard-block" id="all-app"><h2>' + i18next.t("ApplicationList") + '</h2><div id="appList1"></div></section></div>';
...
am.dispViewApp = function(schema, dispName, imageSrc, description, barUrl, barBoxName, insFlag) {
    ...
    cm.setTitleMenu(i18next.t("Details"));
